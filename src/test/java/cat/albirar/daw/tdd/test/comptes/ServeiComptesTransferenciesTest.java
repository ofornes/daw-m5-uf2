...
public class ServeiComptesTransferenciesTest extends AbstractServeiComptesTest {
	...
	@Test public void siFemUnaTransferenciaDe100DesDUnCompteAmb500AUnAmb50_EnElPrimerCompteElSaldoSeraDe400IEnElSegonaSeraDe150() {
		serveiComptes.ingressar(c1, BigDecimal.valueOf(500D));
		serveiComptes.ingressar(c2, BigDecimal.valueOf(50D));
		
		assertEquals(BigDecimal.valueOf(150D), serveiComptes.transferir(c1, c2, BigDecimal.valueOf(100D)));
		
		assertEquals(BigDecimal.valueOf(400D), serveiComptes.saldo(c1));
		assertEquals(BigDecimal.valueOf(150D), serveiComptes.saldo(c2));
	}
	/**
	...
	@Test public void siFemUnaTransferenciaDe100NegatiusDesDUnCompteAmb500AUnAmb50_ElsSaldosEsQuedenAmb500I50Respectivament() {
		...
		assertThrows(ValidationException.class, () -> serveiComptes.transferir(c1, c2, BigDecimal.valueOf(-100D)));

		assertEquals(BigDecimal.valueOf(500D), serveiComptes.saldo(c1));
		assertEquals(BigDecimal.valueOf(50D), serveiComptes.saldo(c2));
	}
	/**
	...
	@Test public void siFemUnaTransferenciaDe3000DesDUnCompteAmb3500AUnCompteAmb50_enElPrimerCompteElSaldoQuedaraEn500IEnElSegonEn3050() {
		serveiComptes.ingressar(c1, BigDecimal.valueOf(3500D));
		serveiComptes.ingressar(c2, BigDecimal.valueOf(50D));
		
		assertEquals(BigDecimal.valueOf(3050D), serveiComptes.transferir(c1, c2, BigDecimal.valueOf(3000D)));
		
		assertEquals(BigDecimal.valueOf(500D), serveiComptes.saldo(c1));
		assertEquals(BigDecimal.valueOf(3050D), serveiComptes.saldo(c2));
	}
	/**
	...
	@Test public void siFemUnaTransferenciaDe3000Punt01DesDUnCompteAmb3500AUnCompteAmb50_enElPrimerCompteEsQuedaran3500IEnElSegon50() {
		...
		assertThrows(LimitDiariTransferenciesExceditExcepcio.class, () -> serveiComptes.transferir(c1, c2, BigDecimal.valueOf(3000.01D)));
		
		assertEquals(BigDecimal.valueOf(3500D), serveiComptes.saldo(c1));
		assertEquals(BigDecimal.valueOf(50D), serveiComptes.saldo(c2));
	}
	/**
	...
	@Test public void siFemUnaTransferenciaDe2000DesDUnCompteAmb3500AUnCompteAmb50IJustDespresUnaAltraDe1200_enElPrimerCompteElSaldoQuedaraEn1500IEnLaSegonaEn2050() {
		...
		serveiComptes.transferir(c1, c2, BigDecimal.valueOf(2000D));
		assertThrows(LimitDiariTransferenciesExceditExcepcio.class, () -> serveiComptes.transferir(c1, c2, BigDecimal.valueOf(1200D)));
		
		assertEquals(BigDecimal.valueOf(1500D), serveiComptes.saldo(c1));
		assertEquals(BigDecimal.valueOf(2050D), serveiComptes.saldo(c2));
	}
}
